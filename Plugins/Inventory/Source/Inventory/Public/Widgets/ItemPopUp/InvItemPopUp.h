...
// Widgets/ItemPopUp/InvItemPopUp.h
#pragma once
 ...
 */
UCLASS()
class INVENTORY_API UInvItemPopUp : public UUserWidget
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(meta = (BindWidget))
	TObjectPtr<USizeBox> SizeBox_Root; // 能直接从SizeBox_Root中获取整个ItemPopUp的大小
