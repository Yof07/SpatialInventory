...
// Widgets/Composite/InvLeaf_LabeledValue.cpp

#include "Widgets/Composite/InvLeaf_LabeledValue.h"

#include "Components/TextBlock.h"

void UInvLeaf_LabeledValue::SetText_Label(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UInvLeaf_LabeledValue::SetText_Value(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UInvLeaf_LabeledValue::NativePreConstruct()
{
